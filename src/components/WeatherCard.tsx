  ...
  return (
    <>
      <Stack>
        ...
        <Image src={`./src/assets/images/${description}.png`} width={"150px"} />
          <Heading padding={2} size="2xl">{name}</Heading>
          <Heading padding={2} size={"lg"}>{temp} F</Heading>
          <Heading padding={2} size={"lg"}>{description}</Heading>
        </Flex>
        <Flex>
